...
const EXTERNAL_SUPABASE_ANON_KEY = import.meta.env.VITE_SUPABASE_ANON_KEY || "sb_publishable_v58nZwBN4s5_lMASv4S3Iw_L23jPbIK";
const BLOCKED_INTERNAL_REFS: string[] = []; // Desbloqueado para garantir acesso ao banco especificado


const ENV_URL = "https://fwoescubnnagdvwasbjl.supabase.co";
const ENV_KEY = "sb_publishable_v58nZwBN4s5_lMASv4S3Iw_L23jPbIK";
