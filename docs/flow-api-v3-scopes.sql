-- ============================================================
-- Zailom Flow — Public API v3 (scope messages:send)
-- ------------------------------------------------------------
-- Rodar UMA ÚNICA VEZ no SQL Editor do Supabase externo,
-- DEPOIS de docs/flow-api-v2-scopes.sql.
--
-- Adiciona o escopo `messages:send`, usado pelo Zailom Booking na
-- rota POST /flow-api/v1/messages/send quando o canal da instância
-- está com channel_preference = "flow".
--
...
-- 2) Validação dentro de create_flow_api_key
